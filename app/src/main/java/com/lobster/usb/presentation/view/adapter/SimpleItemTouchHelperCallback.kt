...
import com.lobster.usb.presentation.ui.symbols_list.SymbolsListAdapter
 ...
 */
class SimpleItemTouchHelperCallback(private val mAdapter: SymbolsListAdapter.SymbolsAdapter) :
    ...
    override fun onSelectedChanged(viewHolder: RecyclerView.ViewHolder?, actionState: Int) {
        ...
        if (actionState != ItemTouchHelper.ACTION_STATE_IDLE) {
            if (viewHolder is SymbolsListAdapter.SymbolsAdapter.SymbolsViewHolder) {
